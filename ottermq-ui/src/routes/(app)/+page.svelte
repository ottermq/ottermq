		...
		{#if data}
			<table>
				<tbody>
					...
					<tr
						><td class="label">File Descriptors</td><td class="value"
							><span>{data.node.fd_used} / {data.node.fd_limit} </span></td
						></tr
					>
					<tr
						><td class="label">Memory</td><td class="value"
							><span>
								{formatBytes(data.node.memory_usage)} / {formatBytes(data.node.memory_limit)}</span
							></td
						></tr
					>
				</tbody>
